...
if(CMAKE_CXX_STANDARD GREATER_EQUAL 20)
    option(FMT_USE_MODULES "Build CXX_MODULES" ${CMAKE_CXX_SCAN_FOR_MODULES})
endif()
...
message(STATUS "FMT_USE_STD_MODULE=${FMT_USE_STD_MODULE}")

if(FMT_USE_MODULES AND FMT_USE_STD_MODULE)
    # -------------------------------------------------------------------------
    ...
    message(STATUS "FMT_HAS_IMPORT_STD=${FMT_HAS_IMPORT_STD}")
endif()

if(NOT FMT_USE_MODULES)
    set(CMAKE_CXX_SCAN_FOR_MODULES OFF)
endif()
